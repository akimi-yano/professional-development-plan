...
namespace WhereAmI
{
    class MapImage
    {
        ...
        private static Uri BuildURI(GeoCoordinate location)
        {
            ...
            // Get the API key from https://developer.here.com/documentation/authentication/dev_guide/index.html
            string API_KEY = "";
            ...
            return new Uri(HereApi_URL + $"?apiKey = {API_KEY}&u={location.HorizontalAccuracy}"  + latlon);
        }
